        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
                ...
                <h4 style="color: red">
                 * Question Bank contains the questions that have been added by you.   
                </h4>
                <h4 style="color: red">
                 * Add new question allows you to enter new questions.
                </h4>
              
              <h3><a href="question_bank_display.jsp">Question Bank</a></h3>
