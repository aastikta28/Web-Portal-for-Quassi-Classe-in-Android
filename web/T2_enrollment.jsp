...
Class.forName("com.mysql.jdbc.Driver").newInstance();
    ...
    ResultSet rs=s.executeQuery("select * from enrollment_list");
    %>
          <form border="1" name="form" action="T2_addnew.jsp">
          <table >
              <tr >
    ...
    while(rs.next())
            {
       String inst_id, stud_id, cA,cB, cC ;
      // int credit;
        quesn_num=rs.getInt(6);
        ...
        cC=rs.getString(5);
                        ...
                        %>
                            ...
                            <tr>
                                ...
                                <td colspan = "1" align = "center"><%=stud_id%></td>
                                <td colspan = "1" align = "center"><%=cA%></td>
                                <td colspan = "1" align = "center"><%=cB%></td>
                                <td colspan = "1" align = "center"><%=cC%></td>
                                <td colspan = "1" align = "center"><input type="button" name="edit" value="Edit" style="background-color:#49743D;font-weight:bold;color:#ffffff;" onclick="editRecord(<%=quesn_num%>);" ></td>
                                <td colspan = "1" align = "center"><input type="button" name="delete" value="Delete" style="background-color:#ff0000;font-weight:bold;color:#ffffff;" onclick="deleteRecord(<%=quesn_num%>);" ></td>
</tr>
<tr>
