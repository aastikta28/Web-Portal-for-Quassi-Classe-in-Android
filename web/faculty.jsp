      ...
      <div class="wrapper">
        <article class="col1">
            ...
            <div class="wrapper pad_bot2">
              <figure class="left marg_right1"><img src="images/aghila.jpg" alt=""></figure>
              <p class="pad_top2"><strong>Prof. Dr. G. Aghila </strong><br>
              </p>
              </div>
            <div class="wrapper pad_bot2">
              <figure class="left marg_right1"><img src="images/arun.JPG" alt=""></figure>
              <p class="pad_top2"><strong>Dr. Arun Raj Kumar, P. </strong><br>
                </p>
               </div>
            <div class="wrapper">
              <figure class="left marg_right1"><img src="images/narenraj.jpg" alt=""></figure>
              <p class="pad_top2"><strong>Dr. Narendran Rajagopalan </strong><br>
                 </div>
