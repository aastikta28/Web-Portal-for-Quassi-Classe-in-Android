        ...
        <div class="wrapper">
          <article class="col1">
            <div class="pad_left1">
              ...
              <p class="font2">Quassi Classe` is developed keeping in mind of the students who can make use of this from remote area in order to provide better education in India.</p>
