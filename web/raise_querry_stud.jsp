  ...
  <div class="main">
    ...
    <section id="content">
      ...
      <div class="box1">
        <div >
          <article >
             ...
             <form action="stud_querry_db.jsp" method="post" class="Form">
      ...
      <li class="form-line" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="margin-left:156px" class="form-buttons-wrapper">
            <input id="input_2" type="submit" class="button" value ="Submit Query" onclick="stud_querry_db.jsp">
      ...
      <li class="form-line" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="margin-left:156px" class="form-buttons-wrapper">
            <h3><a href="raise_querry_result.jsp">Click to view Answers !!</a></h3>
