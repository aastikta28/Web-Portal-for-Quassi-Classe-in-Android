        ...
        <div class="main">
            ...
            <section id="content">
                ...
                <h3><a>Options:</a></h3>
                            ...
                            <h3><input type="checkbox" name="option1" value="A" id="option1_0">A. 
                             
                            <input type="text" name="textieA" style="border-style:solid;"></h3>
                            
                           
                            <h3><input type="checkbox" name="option1" value="B" id="option1_1">B. 
                            <input type="text" name="textieB" style="border-style:solid;"></h3>
                            
                            <h3><input type="checkbox" name="option1" value="C" id="option1_2">C. 
                            <input type="text" name="textieC" style="border-style:solid;"></h3>
                            
                                <h3><input type="checkbox" name="option1" value="D" id="option1_3">D. 
                            <input type="text" name="textieD" style="border-style:solid;"></h3>
                           
                            <h3><input type="checkbox" name="option1" value="E" id="option1_4">E. 
